...
<div class="services-full-width-container">
        	<div class="container portal_development">
             <div class="col-sm-12">
              <div class="col-sm-8">
              <h3>College Management System India</h3>
                        <p>Our college management system explains the whole system relative to college management and covering almost all the four modules. We also mention many more management software features in our blog. College is an academy of higher education, fundamentally, composed of faculty and students. It is governed by set of rules, regulations and functions under a constitution of authority which can be either governmental or non governmental. An academy of higher learning and providing a general and liberal arts education rather than technical and professional training.</p>

<h3>College Management System Modules</h3>
<ul class="list">
<li>Students Management System</li>
<li>Staff Management System</li>
<li>Syllabus Management System</li>
<li>Automatic Timetable</li>
...
<h3>College Management System Demo</h3>
<div class="col-sm-12 no-padding">
						<div class="col-sm-6 portal_demo">
							<a data-fancybox-group="gallery" href="#" class="fancybox"><img alt="" src="images/college-management-system-1.jpg" kasperskylab_antibanner="on"></a></div>
						<div class="col-sm-6 portal_demo">
							<a data-fancybox-group="gallery" href="#" class="fancybox"><img alt="" src="images/college-management-system-2.jpg" kasperskylab_antibanner="on"></a>	
						</div>
						</div>
                       
                        <div class="col-sm-12 no-padding">
						<div class="col-sm-6 portal_demo">
							<a data-fancybox-group="gallery" href="#" class="fancybox"><img alt="" src="images/college-management-system-3.jpg" kasperskylab_antibanner="on"></a>
						</div> 
						<div class="col-sm-6 portal_demo">
							<a data-fancybox-group="gallery" href="#" class="fancybox"><img alt="" src="images/college-management-system-4.jpg" kasperskylab_antibanner="on"></a>
						</div> 
					</div>
                    
                    <p>College Management System Chennai - College Management Software India - <strong>College Management Software Chennai - College Management ERP Software Chennai - College Management ERP System Chennai - College Management System ERP</strong></p>
                     <div id="thanks"></div>
