        	...
        	<div class="container portal_development">
             <div class="col-sm-12">
              ...
              <h3>ERP for Trading Business</h3>
                        <p>InysolTechnologies ERP system is a leading web-based enterprise solution for all your trading business. This ERP package consists of integrated business application with better decision making-tools. InysolTechnologies ERP system provides an end-to-end solution that organizes and controls every aspect of business from order management, operations, supply-chain and logistics, to documentation, accounting and business intelligence reporting.</p>
