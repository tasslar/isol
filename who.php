        	...
        	<div class="container">
                ...
                <div class="col-sm-3 sidebar-phone">
                   <img src="images/sidebar.jpg"  class="img-responsive" />
                    ...
                    <div class="left-mg">
	                    <h3>Who we are?</h3>
	                   	<p>Inysol Innovative Solutions a professional web design and development company in India providing a range of affordable custom website design,development services to clients across the world.

Inysol Innovative Solutions is a recognized online promotion company delivering web development services of any complexity level to their clients worldwide. Inysol Innovative Solutions is a dynamically well established web Designing and Development company with strong and talented team of experienced IT experts with excellent domain knowledge across various development platforms, our global clientele base range from start-ups to large organizations. India which brings together a classic blend of creativity, revolutionary ideas coupled with cutting edge technology.</p>

<p>Our web design and web development services range from simple static web site design to dynamic web application solutions. As a leading web design and web development company in India, Inysol Innovative Solutions has the best and most professional web design and web development team providing affordable Web Site Design Solutions, Web Site Development and Web application development. Despite of being a company serving clients globally we have a special focus on India, United Kingdom (UK), Canada and United States of America (US).
