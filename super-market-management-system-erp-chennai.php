...
<div class="services-full-width-container">
        	<div class="container portal_development">
             <div class="col-sm-12">
              <div class="col-sm-8">
              <h3>Supermarket Management System India</h3>
                        <p>Our supermarket management system, a form of grocery store, is a self-service store offering a wide variety of food and household merchandise, organized into departments. We have updated Super Market management System Detailed products, it helps the store keeper to keep records of sold out and intake products details, advanced feature of bar-coding verifications and billing system to the customers.</p>

						<h3>Supermarket Management System</h3>                       
                      
                    
                    <p>  Supermarket Management System Chennai - Supermarket Management Software Chennai - <strong>Supermarket Management Software India - Supermarket ERP Software Chennai - Supermarket ERP Software India - Cloud Supermarket Management System Chennai - Cloud Supermarket Management System India</strong></p>
                    <div id="thanks"></div>
