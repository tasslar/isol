...
<h3>Online Booking Management System Modules</h3>   
    ...
    <p style="padding-left:5%;">1.Companies list</p>
    <p style="padding-left:5%;">2.Activity Operator</p>
    <p style="padding-left:5%;">3.Adventure Outfitters</p>
    <p style="padding-left:5%;">4.Tour and Activity Resellers</p>
    <p style="padding-left:5%;">5.Attractions</p>
...
<ul>
   ...
   <li>If your business offers this kind of service, then Inysol Innovative Technology Solutions  will be a great fit for you.</li>
                    ...
                    <p> Online Booking Management System Chennai - Online Booking Management System India - <strong>Online Booking Management Software Chennai - Online Booking Managment Software India - Web Based Booking Management System Chennai - Web Based Booking Management System India</strong></p>
                     <div id="thanks"></div>
