...
<div class="services-full-width-container">
        	<div class="container portal_development">
             <div class="col-sm-12">
              <div class="col-sm-8">
              <h3>ERP for Manufacturing Company</h3><br />
                        <p>Tasstechnologies ERP is a comprehensive enterprise resource Planning system that offers best-practice support for multi-mode manufacturers in a broad range of Industries. In today's aggressive business environment it is essential to be prepared to face a vast and competitive world. In this time of diminishing global economic situation, the most worried sectors are the small and midsize businesses (SMBs).<br /><br />

They are challenged by the requirement of the customer and compliance mandates, effective management of supplier, costs control and finding new customers to grow the business. Tasstechnologies ERP offers solution that enables manufacturers to compete in the prevailing market atmosphere. Tasstechnologies Manufacturing has the capacity of both finite and infinite planning capabilities which assist you to develop original schedule. Tasstechnologies Manufacturing Management also transforms the supply chain to achieve production plan with your sales plan, manufacturing, finance and customers.</p> 
<h3>ERP for Manufacturing Company Modules</h3>
<ul class="list">
<li class="firstItem" title="erp in india">Admin</li>
<li title="erp in india">Human Resource</li>
<li title="erp in india">Productions</li>
<li title="erp in india">Job Masters</li>
<li title="erp in india">Internal Word Order</li>
<li title="erp in india">Production Entry</li>
<li title="erp in india">Reports</li>
<li class="lastItem" title="erp in india">Inventory</li>
</ul>
<h3 class="visible visible-first" title="top 10 erp company in india">ERP for Manufacturing Company Demo</h3>
<!--<div class="col-sm-12 no-padding">
						<div class="col-sm-6 portal_demo">
							<a data-fancybox-group="gallery" href="#" class="fancybox"><img alt="" src="images/erp-for-manufacturing-1.jpg" kasperskylab_antibanner="on"></a></div>
						<div class="col-sm-6 portal_demo">
							<a data-fancybox-group="gallery" href="#" class="fancybox"><img alt="" src="images/erp-for-manufacturing-2.jpg" kasperskylab_antibanner="on"></a>	
						</div>
						</div>
                       
                        <div class="col-sm-12 no-padding">
						<div class="col-sm-6 portal_demo">
							<a data-fancybox-group="gallery" href="#" class="fancybox"><img alt="" src="images/erp-for-manufacturing-3.jpg" kasperskylab_antibanner="on"></a>
						</div> 
						<div class="col-sm-6 portal_demo">
							<a data-fancybox-group="gallery" href="#" class="fancybox"><img alt="" src="images/erp-for-manufacturing-4.jpg" kasperskylab_antibanner="on"></a>
						</div> 
					</div>-->
