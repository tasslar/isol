...
<div class="services-full-width-container">
        	<div class="container portal_development">
             <div class="col-sm-12">
              <div class="col-sm-8" style="min-height:750px;">
                            
						<h3>Machinery Management System Demo</h3>
                        <!--<div class="col-sm-12 no-padding">
						<div class="col-sm-6 portal_demo">
							<a data-fancybox-group="gallery" href="#" class="fancybox"><img alt="" src="images/machinery-management-system-1.jpg" kasperskylab_antibanner="on"></a>
						</div> 
						<div class="col-sm-6 portal_demo">
							<a data-fancybox-group="gallery" href="#" class="fancybox"><img alt="" src="images/machinery-management-system-2.jpg" kasperskylab_antibanner="on"></a>
						</div> 
					</div>
                     <div class="col-sm-12 no-padding">
						<div class="col-sm-6 portal_demo">
							<a data-fancybox-group="gallery" href="#" class="fancybox"><img alt="" src="images/machinery-management-system-3.jpg" kasperskylab_antibanner="on"></a>
						</div> 
						<div class="col-sm-6 portal_demo">
							<a data-fancybox-group="gallery" href="#" class="fancybox"><img alt="" src="images/machinery-management-system-4.jpg" kasperskylab_antibanner="on"></a>
						</div> 
					</div>-->
                    
                    <p> Machinery Management System Chennai - Machinery Management System India - <strong>SME's Machinery Management System Chennai - SME's Machinery Management System India - Machinery Management Software Chennai - Machinery Management Software India</strong></p>
                    <div id="thanks"></div>
